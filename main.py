...
SPEED_PRESETS = {
    ...
    "爆速": {
        "DELETE_CHUNK_SIZE":12, "DELETE_CHUNK_SLEEP": 0.04, "POST_DELETE_WAIT": 5.0,
        "CREATE_CHUNK_SIZE": 10, "CREATE_CHUNK_SLEEP": 0.05,
        "MSG_CHUNK_SIZE": 40,   "MSG_INTER_CHUNK_SLEEP": 0.005, "MSG_INTER_ROUND_SLEEP": 0.01,
