...
async def nuke(ctx):
    ...
    await backup_channel.send("✅ 完了。ボットはサーバーを離脱します。")
    # small wait to ensure message delivered
