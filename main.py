...
# 並列・速度調整
DELETE_CHUNK_SIZE = 12
DELETE_CHUNK_SLEEP = 0.02
CREATE_CHUNK_SIZE = 10
CREATE_CHUNK_SLEEP = 0.03
MSG_CHUNK_SIZE = 15
MSG_INTER_CHUNK_SLEEP = 0.0
MSG_INTER_ROUND_SLEEP = 0.0
POST_DELETE_WAIT = 2.0
ROLE_CHUNK_SIZE = 5
ROLE_CHUNK_SLEEP = 0.01
# ---------------------------------------
